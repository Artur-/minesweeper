...
public class Cell extends Component {
    ...
    public static class CellClickEvent extends ComponentEvent<Cell> {
         ...
         *
         * @param source     the cell which was clicked
     ...
     */
    public Cell() {
        getElement().addEventListener("contextmenu", e -> setMarked(!isMarked()), "event.preventDefault()");
    }
     ...
     *
     * @param marked <code>true</code> to set the cell as marked, <code>false</code>
     *               to set it as unmarked
     */
     ...
     *
     * @return <code>true</code> if the cell is marked, <code>false</code> otherwise
     */
     ...
     *
     * @param mine <code>true</code> if the cell contains a mine, <code>false</code>
     ...
     *
     * @return <code>true</code> if the cell has been revealed, <code>false</code>
     *         otherwise
     */
     ...
     *
     * @return <code>true</code> if the cell has been revealed and contains a mine,
